...
public class HillClimbingAlgorithm {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
       ...
       Node endNode = null;
        ...
        System.out.println(getShortestPath(startNode,0));
    }
    ...
    private static int getShortestPath(Node startNode,int totalPath) {
       ...
       if(startNode.leastPath!=-1 && startNode.leastPath<totalPath)
        ...
        if(path==200000 && startNode.leastPath !=-1) {
    ...
    private static List<String> readInput() throws IOException, URISyntaxException {
        return Files.readAllLines(Paths.get(Objects.requireNonNull(HillClimbingAlgorithm.class.getResource("input.txt")).toURI()));
    }
